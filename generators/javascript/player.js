...
Blockly.JavaScript['player'] = function(block) {
	...
	var argument0 = Blockly.JavaScript.variableDB_.getName(block.getFieldValue('NAME'), Blockly.Variables.NAME_TYPE);


	//var argument1 = Blockly.JavaScript.valueToCode(block, 'TEXT',
	//	Blockly.JavaScript.ORDER_NONE) || '\'\'';
	//return 'window.alert(' + argument0 + ');\n';
	return 'player.scaleTo(' + argument0 + ',' + argument0 + ',' + argument0 + ');';
};
